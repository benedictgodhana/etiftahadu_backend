    ...
    public function getUserCount()
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'role' => 'required|exists:roles,id', // Validate role ID exists in roles table
        ]);
        ...
        $user->assignRole($role); // Assign role using Spatie's method

        // Eager load roles and creator relationships
        $user->load('roles', 'creator'); // Load roles and creator relationships

        // Return user data with role name
        return response()->json([
            'success' => true,
            'user' => [
                'id' => $user->id,
                ...
                'role_name' => $role->name, // Include the role name here
                'roles' => $user->roles->pluck('name'), // Role names as an array
                'creator_name' => $user->creator->name ?? 'N/A',
            ]
        ], 201);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Load roles and creator relationships
        $user->load('roles', 'creator'); // Eager load roles and creator
